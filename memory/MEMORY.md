...
[2026-05-17] [[style-plan]] Этап 2 блейзер — найден кандидат на WB: **Paolo Marni оверсайз чёрный, артикул 235679763**, 181.56 BYN (распродажа -54% от 392), хлопок 60% + полиэстер 30% + эластан 10%, 4.6/5 от 608 оценок, Турция, размеры 42-58 (Vovan'у 48 и 50 для примерки). Средний сегмент — для первой итерации норм, премиум-апгрейд при желании: Lemonbrand / Tom Tailor / Massimo Dutti через Lamoda 400-800 BYN. Ссылка: https://www.wildberries.by/catalog/235679763/detail.aspx
