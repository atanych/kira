...
- [2026-04-30] [[book-summary]] Rating set (shipped 2026-04-29): 🎯 Originality (merge of old Core Ideas + Overlap), 📦 Density, ⚡ Actionability, ✍️ Writing Quality (NEW — info-per-page vs reading experience are separate signals), 🕐 Time Relevance, 🎓 Difficulty. Template placeholders: {{ORIGINALITY}}, {{WRITING}}. Removed: {{CORE}}, {{OVERLAP}}.
- [2026-04-23] [[book-summary]] For deep-dive books Vovan prefers **Option A**: 3× focused 5-min audio deep-dives per technique, NOT one long 15-min recap. Each deep-dive isolates one mechanic with examples.
- [2026-04-27] [[book-summary]] ElevenLabs quota — a deep-dive series (3 audios × ~5000 credits each) can hit the cap. Before kicking off a series, check remaining credits; if it can't cover the full set, warn Vovan upfront — never deliver a half-finished series.
- [2026-05-19] [[book-summary]] ElevenLabs voice ID — источник истины **config.json voice.voiceId**, НЕ хардкод в SKILL.md. Текущий ID: QeKcckTBICc3UuWL7ETc (был раньше Jessica cgSgspJ2msm6clMCkdW9). Если меняется в config.json — никаких обновлений в скилле не требуется. Это правило установлено 2026-05-18 после self-review proposal на voice reconcile.
